function [out] = fit_model_revrepwgh_leak(cfg)
%  FIT_MODEL_REVREPWGH  Fit leaky inference model to reversal and repetition 
%  curves with respect to stimulus weight
%
